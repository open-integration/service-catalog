...
GOOS=darwin GOARCH=amd64 go build -o ../dist/$NAME-$VERSION-darwin-amd64 .

echo "Building $NAME-$VERSION service fro linux and amd64"
GOOS=linux GOARCH=amd64 go build -o ../dist/$NAME-$VERSION-linux-amd64 .

echo "Building $NAME-$VERSION service fro linux and 386"
GOOS=linux GOARCH=386 go build -o ../dist/$NAME-$VERSION-linux-386 .